...
# EDIT THESE PATHS
# =======================
INPUT_CSV = r"C:\Users\poula\Desktop\quad redo\Bace 1\bace1_clean_ecfp4_2048.csv"
...
def main():
    ...
    split_csv = os.path.join(OUT_DIR, "bace1_frozen_split_ecfp4_2048.csv")
    ...
    metrics_txt = os.path.join(OUT_DIR, "bace1_baseline_rf_metrics.txt")
    with open(metrics_txt, "w", encoding="utf-8") as f:
        f.write(f"Dataset: BACE1\n")
    ...
    plot_path = os.path.join(OUT_DIR, "bace1_regression_measured_vs_predicted.png")
    ...
    plt.title(f"BACE1 Test Set: Measured vs Predicted\nR2={r2:.3f}, RMSE={rmse:.3f}, MAE={mae:.3f}")
    plt.tight_layout()
